                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>  
                    ...
                    <?php
                                ...
                                $qry =" SELECT * FROM `producttesting`";
                                $result = mysqli_query($conn,$qry);
                                while($row = mysqli_fetch_assoc($result)){?>


                            <td scope="row"><?PHP echo $row['ProductTestID']?>  </td>
                            
                              <td><?PHP echo $row['TestID']?></td>
                              <td><?PHP echo $row['UserID']?></td>
                              <td><?PHP echo $row['RemarksID']?></td>
                              <td><?PHP echo $row['Remarks']?></td>
                           
                            <td>
                                    <a href="update.php?updid=<?PHP echo $row['ProductTestID']?>">
                                    <button type="button" class="btn btn-success btn-fw">Update</button>
                                    </a>

                                    <a href="delete.php?dldid=<?PHP echo $row['ProductTestID']?>">
